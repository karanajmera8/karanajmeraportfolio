  ...
  return (
    <section id='about-me'>
      <div className='about-container'>
        <h2 className='about-title' style={{fontSize:'60px'}}>About Me</h2>
        <p className='about-summary'>With a back-ground in Telecommunications and Information Technology, I transitioned into Software Engineering to blend my passion for problem-solving with technology. Equipped with hands-on experience in React, Django, Python, JS, I bring a unique perspective from Telecommunications, which enhances my approach to building innovative solutions. I thrive in collaborative environments, constantly learning and adapting to new challenges in software development. Whether it's creating efficient code, optimizing systems, or building user-centric applications, I’m dedicated to delivering high-quality results that drive impact. I'm a full-stack developer with great experience and passion for coding! Professional with a Master's in Information Technology and experience of over 8 years in Technology</p>
